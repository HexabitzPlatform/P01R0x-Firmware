/*
 ...
 File Name     : P01R0.h
 Description   : Header file for module P01R0.
...
typedef enum {
	P01R0_OK =0, P01R0_ERR_UnknownMessage, P01R0_ERR_WrongColor, P01R0_ERR_WrongIntensity, P01R0_ERR_WrongMode, P01R0_ERROR =255
} Module_Status;
